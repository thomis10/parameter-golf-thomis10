...
class CausalSelfAttention(nn.Module):
    def __init__(
        ...
        rank = dim // 4
        self.proj_down = CastedLinear(dim, rank, bias=False)
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        return self.proj_up(self.proj_down(y))
...
class MLP(nn.Module):
    ...
    def forward(self, x: Tensor) -> Tensor:
        x = torch.relu(self.fc_up(self.fc_down(x)))
        return self.proj_up(self.proj_down(x.square()))
